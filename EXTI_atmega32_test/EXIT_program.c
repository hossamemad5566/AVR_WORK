...
static void (*ECTI_APCallBack[3])(void)={NULL,NULL,NULL};

u8 EXTI_u8SetCallBack(void(*pf)(void),u8 Copy_u8EXTIIndex)
{
    u8 Local_u8ReturnType = STD_TYPE_OK;
    if((pf != NULL) &&(Copy_u8EXTIIndex <= EXTI_U8_INDX2))
    {
...
{
	if(ECTI_APCallBack[EXTI_U8_INDX2] != NULL)
	{
        ECTI_APCallBack[EXTI_U8_INDX2]();
    }
}
